        ...
        <CodeBlock title="renderAboutMe()">
          <div className="about-content">
            <div className="text">
              ...
              <p>As a Software Engineer, I’m always looking to challenge my technical knowledge and abilities. I’ve been fortunate enough to develop my skill set through a diverse set of projects ranging from Wordpress development, large scale cloud hosting migration, performance optimization, RESTful applications, and people management.</p>
            </div>
